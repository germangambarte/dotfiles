...
keymap.set("i", "jk", "<ESC><cmd>nohl<CR>", { desc = "Exit insert mode with jk" })
keymap.set("n", "<esc>", "<ESC><cmd>nohl<CR>", { desc = "Exit insert mode with jk" })
...
keymap.set({ "n", "t" }, "<C-Up>", ":resize -2<CR>")
keymap.set({ "n", "t" }, "<C-Down>", ":resize +2<CR>")
